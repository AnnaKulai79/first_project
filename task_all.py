...
# n3 = number % 10
# n4 = number // 10
# print(n1 != n2 and n1 != n3 and n1 != n4 and n2!= n3 and n2!= n4 and n3!= n4)
...
# print(number[0] == number[3] and number[1] == number[2])
...
#  False
#  Розділ: РОЗГАЛУЖЕННЯ | Рівень складності: ВИСОКИЙ
# number = int(input("Enter number(128-255): \n"))
# number2 = ""
# while number > 0:
#     number2 += str(number % 2)
#     number //= 2
# print(number2[:4] == ''.join(reversed(number2[4:])))
...
#  6.7.2019
#  Розділ: РОЗГАЛУЖЕННЯ | Рівень складності: ВИСОКИЙ
# dday = int(input("Enter data: \n"))
# mmon = int(input())
# year = int(input())
# mon31 = [1, 3, 5, 7, 8, 10, 12]
# leap = 0
# if dday < 28:
#     print(dday + 1, mmon, year, sep=".")
# elif mmon in mon31:
#     if dday < 31:
#         print(dday + 1, mmon, year, sep=".")
#     elif mmon < 12:
#         print(1, mmon + 1, year, sep=".")
#     else:
#         print(1, 1, year + 1, sep=".")        
# elif mmon == 2:
#     if (year % 4) == 0:
#         if (year % 100) == 0:
#             if (year % 400) == 0:
...
#     print(dday -1 , mmon, year, sep=".")
# elif mmon in mon31:
#     print(31, mmon - 1, year, sep=".")
# elif mmon in mon30:
#     print(30, mmon - 1, year, sep=".")
# elif mmon == 1:
#     print(31, 12, year - 1, sep=".")
# else:
#     if (year % 4) == 0:
#         if (year % 100) == 0:
#             if (year % 400) == 0:
